...
setPaths(modulePath = file.path("C:/Users/chris.mallon"))
...
df_params <- SpaDES.core::moduleParams("vsdm", "C:/Users/chris.mallon")
...
If `sourceURL` is specified, `downloadData("vsdm", "C:/Users/chris.mallon")` may be sufficient.

```{r moduleInputs, echo = FALSE, eval = TRUE}
df_inputs <- SpaDES.core::moduleInputs("vsdm", "C:/Users/chris.mallon")
...
df_outputs <- SpaDES.core::moduleOutputs("vsdm", "C:/Users/chris.mallon")
